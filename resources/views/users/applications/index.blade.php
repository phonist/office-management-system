                ...
                <div class="card-body">
                    <table id="responsive-datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $application->leaveType($application->id) }}</td>
                                
                                <td>{{ $application->timeFormat($application->start) }}</td>
                                <td>{{ $application->timeFormat($application->end) }}</td>
                                <td>{{ $application->reason }}</td>
                                <td>{{ $application->timeFormat($application->date) }}</td>
...
<div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
    aria-hidden="true">
    @include('users.applications.create')
</div>
