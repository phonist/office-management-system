<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header bg-info">
            <h5 class="modal-title" id="exampleModalLabel">Import Client(s)</h5>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-6">
                        <form action="{{ route('client.import') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                            @csrf
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{ route('client.download') }}"><i class="icon-fa icon-fa-arrow-circle-down" aria-hidden="true"></i>
                        Sample CSV File</a>
                </div>
            </div>
