...
<div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form action="#" id="editSalaryComponentForm" method="post" class="form-horizontal">
                    @method('put')
                    @csrf
                    <div class="modal-body form">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input name="component_name" class="form-control edit_name autocomplete_off" type="text">
                            ...
                            <table style="width: 100%; padding-left: 50px">
                                <tbody>
                                    <tr style="height: 50px">
                                        ...
                                        <td>
                                            <label class="css-input css-radio css-radio-success push-10-r" id="edit_type_1">
                                                <input name="type" value="1" type="radio"><span></span>Earning
                                            </label>
                                        </td>
                                        <td>
                                            <label class="css-input css-radio css-radio-success push-10-r" id="edit_type_2">
                                                <input name="type" value="2" type="radio"><span></span> Deduction
                                            </label>
                                        </td>
                                    </tr>
                                    ...
                                    <tr style="height: 50px">
                                        ...
                                        <td>
                                            ...
                                            <label class="css-input css-checkbox css-checkbox-success" id="edit_t_pay">
                                                <input name="total_payable" value="1" type="checkbox"><span></span> Total
                                                Payable </label>
                                        </td>
                                        <td>
                                            <label class="css-input css-checkbox css-checkbox-success" id="edit_t_cost">
                                    ...
                                    <tr style="height: 50px">
                                        ...
                                        <td>
                                            <label class="css-input css-radio css-radio-success push-10-r" id="edit_amt">
                                                <input name="value_type" value="1" type="radio"><span></span>Amount
                                            </label>
                                        </td>
                                        <td>
                                            <label class="css-input css-radio css-radio-success push-10-r" id="edit_percentage">
